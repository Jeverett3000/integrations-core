...
class InstanceConfig(BaseModel):
    ...
    db_exclude: Optional[Sequence[str]]
    db_include: Optional[Sequence[str]]
    ...
    max_dbs_per_check: Optional[int]
    max_nodes_per_check: Optional[int]
    ...
    def _run_validations(cls, v, field):
        return (
            getattr(validators, f'instance_{field.name}', identity)(v, field=field)
            if v
            else v
        )
